...
# 提交到仓库
git add .
git commit -m "Initial commit: 20 nodes ready"
...
| 01:00-03:00 | 分发密钥 | 分发节点编号 001-020，发送仓库地址和操作指南 |
| 03:00-08:00 | 并发写入 | 20人同时 Push，大屏实时显示节点变绿 |
...
- **终端风格**：深色背景 #0d1117，绿色文字 #00ff41
- **节点状态**：🔴 OFFLINE → 🟡 COMMIT DETECTED → 🟢 ONLINE
- **终局特效**：Matrix 代码雨 + 几何线条马 ASCII Art
- **纪念卡**：自动生成 PNG 证书，包含所有参与者信息
